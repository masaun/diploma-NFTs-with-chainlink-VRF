...
const KOVAN_RPC_URL = process.env.ALCHEMY_KOVAN_RPC_URL || "https://eth-kovan.alchemyapi.io/v2/your-api-key"
const MUMBAI_RPC_URL = process.env.ALCHEMY_MUMBAI_RPC_URL || "https://polygon-mumbai.alchemyapi.io/v2/your-api-key"
...
module.exports = {
    ...
    networks: {
        ...
        rinkeby: {
            url: RINKEBY_RPC_URL,        /// [NOTE]: Using Alchemy
            // accounts: [PRIVATE_KEY],
            accounts: {
                mnemonic: MNEMONIC,
            },
