...
/**
 * @title The Chainlink Mock Oracle for WeatherNFT contract
 * @notice Chainlink smart contract developers can use this to test their contracts
 */
contract MockOracleForWeatherNFT is ChainlinkRequestInterface, LinkTokenReceiver {
  using SafeMathChainlink for uint256;
  bytes32 public bigRequestId;
  ...
  mapping(bytes32 => Request) public commitments;
